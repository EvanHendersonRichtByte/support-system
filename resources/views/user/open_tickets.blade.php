...
<body class="aps-ctrl-p site-theme site-theme-2 ticket-open">
							...
							<div class="row">
											...
											<div class="panel-body">
												<div class="form-horizontal form-horizontal-text-left">
													<div class="form-group has-feedback">
														<label class="control-label label-required col-md-3" for="title">Ticket Subject</label>
														<div class="col-md-9">
													...
													<div class="form-group has-feedback">
														<label class="control-label label-required col-md-3" for="cat_id">Ticket Category</label>
														<div class="col-md-9">
													...
													<div id="custom-fields" class="">
														<div class="form-group custom-field-group grp-cat-4 grp-AA has-feedback" style="display: none;">
															<label class="control-label  col-md-3 label-required " for="fld_AA">test</label>
															<div class="col-md-9">
														...
														<div class="form-group custom-field-group grp-cat-4 grp-AB has-feedback" style="display: none;">
															<label class="control-label  col-md-3 label-required " for="fld_AB">radio</label>
															<div class="col-md-9">
														...
														<div class="form-group custom-field-group grp-cat-4 grp-AC has-feedback" style="display: none;">
															<label class="control-label  col-md-3 label-required " for="fld_AC">date de retour</label>
															<div class="col-md-9">
														...
														<div class="form-group custom-field-group grp-cat-4  grp-AD" style="display: none;">
															<label class="control-label  col-md-3 label-required " for="fld_AD">Ordinateur</label>
															<div class="col-md-9">
														...
														<div class="form-group custom-field-group grp-cat-4 grp-AE has-feedback" style="display: none;">
															<label class="control-label  col-md-3 label-required " for="fld_AE">test4</label>
															<div class="col-md-9">
								...
								<div class="col-md-4 md-p-l-0">
									<div id="open-src" class="panel panel-default app-panel-box app-panel-box-hlight hidden animated">
										<div class="panel-heading">Suggested Knowledge</div>
									...
									<div class="panel panel-default app-panel-box">
										...
										<div class="panel-body p-0">
											<ul class="kn-list ctg-list">
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/category/details/1/PHP Basic.html">
															<i class="fa fa-angle-double-right"></i> PHP Basic <span class="pull-right">( <i class="fa fa-file-text-o"></i> 15 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/category/details/2/Android Basic.html">
															<i class="fa fa-angle-double-right"></i> Android Basic <span class="pull-right">( <i class="fa fa-file-text-o"></i> 15 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/category/details/3/PHP Setup.html">
															<i class="fa fa-angle-double-right"></i> PHP Setup <span class="pull-right">( <i class="fa fa-file-text-o"></i> 15 )</span>
														</a>
													</h5>
												</li>
												...
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/category/details/5/WordPress Theme Setup.html">
															<i class="fa fa-angle-double-right"></i> WordPress Theme Setup <span class="pull-right">( <i class="fa fa-file-text-o"></i> 15 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/category/details/4/Sales.html">
															<i class="fa fa-angle-double-right"></i> Sales <span class="pull-right">( <i class="fa fa-file-text-o"></i> 14 )</span>
														</a>
													</h5>
												</li>
											</ul>
									...
									<div class="panel panel-default app-panel-box">
										<div class="panel-heading"> Popular Knowledge</div>
										<div class="panel-body p-0">
											<ul class="kn-list ctg-list">
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/knowledge/details/14/cakephp-web-development.html">
															<i class="fa fa-angle-double-right"></i> CakePHP Web Development <span class="pull-right">( <i class="fa fa-eye"></i> 07 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/knowledge/details/88/joomla-zooming-high-in-technology.html">
															<i class="fa fa-angle-double-right"></i> Joomla Zooming High in Technology <span class="pull-right">( <i class="fa fa-eye"></i> 04 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/knowledge/details/15/charts-for-php-pages.html">
															<i class="fa fa-angle-double-right"></i> Charts For PHP Pages <span class="pull-right">( <i class="fa fa-eye"></i> 03 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
													<h5 class="m-0">
														<a href="https://demo.appsbd.com/support-system/knowledge/details/18/android-developer-for-hiring.html">
															<i class="fa fa-angle-double-right"></i> Android Developer For Hiring <span class="pull-right">( <i class="fa fa-eye"></i> 03 )</span>
														</a>
													</h5>
												</li>
												<li class=" p-10  ">
			...
			<div class="xdsoft_calendar">
				<table>
					...
					<tbody>
						...
						<tr>
							<td data-date="19" data-month="6" data-year="2020" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_weekend" title="">
								<div>19</div>
							</td>
	...
	<div id="apbd-cht-container">
		<div id="apbd-cht-conversation" class="apc-msg-window apc-not-started" style="height: 450px; display: none;">
			...
			<div class="apc-msgs">
				<div class="apc-load-move text-center"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
			</div>
