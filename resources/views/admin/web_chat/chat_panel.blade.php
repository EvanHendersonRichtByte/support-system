...
<head>
    ...
    <link rel="stylesheet" href="{{asset('plugins/apsbd-chat/css/appsbd-chat-admin.css?v=1542128234')}}" type="text/css">
    ...
    <script src="{{asset('plugins/apsbd-chat/js/appsbd-chat-admin.min.js?v=1545932274')}}" type="text/javascript"></script>
...
<body class="aps-ctrl-p skin-green sidebar-mini    ">
                                    ...
                                    <div class="apc-pnl-content">
                                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;">
                                            <ul class="apc-chat-list" style="height: 203px; overflow: hidden; width: auto;">
                                                <li id="btn-chat-6" data-istyping="N" data-chatid="6" class="apc-active"><span class="name">Mohamed Sharaf</span><span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                                <li id="btn-chat-4" data-istyping="N" data-chatid="4"><span class="name">Guest User</span><span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                                <li id="btn-chat-3" data-istyping="N" data-chatid="3"><span class="name">Guest User</span><span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                                <li id="btn-chat-2" data-istyping="" data-chatid="2"><span class="name">Guest User</span><span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                                <li id="btn-chat-1" data-istyping="N" data-chatid="1"><span class="name">Guest User</span><span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                            </ul>
                                        ...
                                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;">
                                            <ul class="apc-chat-end-list" style="height: 183px; overflow: hidden; width: auto;">
                                                <li id="btn-chat-5" data-istyping="N" data-chatid="5"><span class="name">Mohamed Sharaf</span> <span class="apc-rtc-c badge"><span class="apc-btn-rc">0</span></span></li>
                                            </ul>
                                            <div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 183px;"></div>
                                            <div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="apc-pnl-content">
                                        <div class="apc-chat-item-content">
                                            <div id="chat_id_5" style="display: none;" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="5"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                                <div id="AAAA" data-msg-id="AAAA" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">**DEMO MODE AUTO RESPONSE-Welcome to our chat session.
                                                        <br>I am admin, how may I help you sir? </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:40</span></div>
                                                </div>
                                                <div id="3ace64ef_1582146635049" data-msg-id="AAAB" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hello </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:40</span></div>
                                                </div>
                                                <div id="AAAC" data-msg-id="AAAC" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">**DEMO MODE AUTO RESPONSE- Hello </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:40</span></div>
                                                </div>
                                                <div id="AA1582146672700" data-msg-id="AAAD" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hello Mohamed </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:41</span></div>
                                                </div>
                                                <div id="3ace64ef_1582147686754" data-msg-id="AAAE" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hi </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:58</span></div>
                                                </div>
                                                <div id="AAAF" data-msg-id="AAAF" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">**DEMO MODE AUTO RESPONSE- Hi </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:58</span></div>
                                                </div>
                                                <div id="3ace64ef_1582147689225" data-msg-id="AAAG" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hi 123 </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:58</span></div>
                                                </div>
                                                <div id="AAAH" data-msg-id="AAAH" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                            ...
                                            <div id="chat_id_6" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="6" style="display: block;"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                                <div id="3ace64ef_1582147800405" data-msg-id="AAAB" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Helloooooo </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:59</span></div>
                                                </div>
                                                <div id="3ace64ef_1582147917317" data-msg-id="AAAD" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hello </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:01</span></div>
                                                </div>
                                                <div id="AAAE" data-msg-id="AAAE" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">**DEMO MODE AUTO RESPONSE- Hello </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:01</span></div>
                                                </div>
                                                <div id="AA1582147980994" data-msg-id="AAAF" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hi Mohamed </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:03</span></div>
                                                </div>
                                                <div id="AA1582147984145" data-msg-id="AAAG" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">Welcome come to our chat session. it is canned message for you </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:03</span></div>
                                                </div>
                                                <div id="AA1582147987417" data-msg-id="AAAH" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">Thank you very much for contacting us </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:03</span></div>
                                                </div>
                                                <div id="3ace64ef_1582148008493" data-msg-id="AAAI" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">ok </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 03:03</span></div>
                                                </div>
                                                <div id="AAAJ" data-msg-id="AAAJ" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                            ...
                                            <div id="chat_id_4" style="display: none;" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="4"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                                <div id="3ace64ef_1582145914401" data-msg-id="AAAB" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hi </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:28</span></div>
                                                </div>
                                                <div id="3ace64ef_1582145918007" data-msg-id="AAAD" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">Hi </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:28</span></div>
                                                </div>
                                                <div id="AA1582146217633" data-msg-id="AAAF" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">welcome </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:33</span></div>
                                                </div>
                                                <div id="3ace64ef_1582146235884" data-msg-id="AAAG" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">welcome </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:33</span></div>
                                                </div>
                                                <div id="AA1582146252186" data-msg-id="AAAI" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">Welcome come to our chat session. it is canned message for you </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:34</span></div>
                                                </div>
                                                <div id="AA1582146285532" data-msg-id="AAAJ" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">CakePHP Web Development <a target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/14.html">https://demo.appsbd.com/support-system/knowledge/details/14.html</a> </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:34</span></div>
                                                </div>
                                                <div id="AA1582146324712" data-msg-id="AAAK" class="apc-item animated fadeIn apc-msg-item apc-me">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="Chatimg"></div>
                                                    <div class="apc-msg">PHP Application Development<br> <a target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/7/php-application-development–-php-web-development-india.html">https://demo.appsbd.com/support-system/knowledge/details/7/php-application-development–-php-web-development-india.html</a> </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Feb 20, 2020 02:35</span></div>
                                                </div>
                                            </div>
                                            <div id="chat_id_3" style="display: none;" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="3"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                            </div>
                                            <div id="chat_id_2" style="display: none;" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="2"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                                <div id="3ace64ef_1530814809817" data-msg-id="AAAB" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">hi </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Jul 05, 2018 23:50</span></div>
                                                </div>
                                                <div id="3ace64ef_1530814817026" data-msg-id="AAAD" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                    <div class="apc-msg">hello </div>
                                                    <div class="apc-msg-time"> <span class="apc-sending">Jul 05, 2018 23:50</span></div>
                                                </div>
                                            ...
                                            <div id="chat_id_1" style="display: none;" class="apc-msgs">
                                                <div class="apc-load-move text-center" data-chat-id="1"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-circle-o-down"></i> Load More</button></div>
                                                <div id="3ace64ef_1530814805054" data-msg-id="AAAB" class="apc-item animated fadeIn apc-msg-item ">
                                                    <div class="apc-umg"><img src="https://demo.appsbd.com/support-system/images/no-image.png" alt="Chatimg"></div>
                                                ...
                                                <div class="panel-heading">
                                                    <div class="chat-canned-msg form-inline ">
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <button id="chat-canned-msg-btn" class="btn btn-success btn-xs added-ripples">Send</button>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="apc-chat-user-info">
                                    ...
                                    <div class="apc-pnl-content">
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt>End Time</dt>
                                            <dd id="dd-end-time">
                                                <button class="chat-end-button btn btn-xs btn-danger added-ripples"><i class="fa fa-times"></i> Close Chat</button>
                                                <span class="endtimestr" style="display: none;"></span>
                                            </dd>
                                        </dl>
                                        <div class="apc-diver apc-kn-search-divder bg-green"><input id="apc-kn-search" type="text" placeholder="Knowledge Search"> <i id="apc-kn-search-loader" class=" fa fa-spin fa-spinner"></i></div>
                                        <div id="apc-kn-container" style="height: 221px;">
                                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 221px;">
                                                <ul id="chat-knowledge" class="list-group" style="height: 221px; overflow: hidden; width: auto;">
                                                    <li class="list-group-item apc-kn-li">
                                                        <a class="apc-kn-title popupform apopf" data-effect="mfp-move-from-top " target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/14.html">
                                                            CakePHP Web Development</a>
                                                        <small>PHP Basic</small>
                                                        <button data-id="#dt-0" class="kn-send-btn btn btn-xs btn-success added-ripples">Send</button>
                                                        <div id="dt-0" class="hidden">CakePHP Web Development https://demo.appsbd.com/support-system/knowledge/details/14.html </div>
                                                    </li>
                                                    <li class="list-group-item apc-kn-li">
                                                        <a class="apc-kn-title popupform apopf" data-effect="mfp-move-from-top " target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/88.html">
                                                            Joomla Zooming High in Technology</a>
                                                        <small>Joomla Theme Setup</small>
                                                        <button data-id="#dt-0" class="kn-send-btn btn btn-xs btn-success added-ripples">Send</button>
                                                        <div id="dt-0" class="hidden">Joomla Zooming High in Technology https://demo.appsbd.com/support-system/knowledge/details/88.html </div>
                                                    </li>
                                                    <li class="list-group-item apc-kn-li">
                                                        <a class="apc-kn-title popupform apopf" data-effect="mfp-move-from-top " target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/15.html">
                                                            Charts For PHP Pages</a>
                                                        <small>PHP Basic</small>
                                                        <button data-id="#dt-0" class="kn-send-btn btn btn-xs btn-success added-ripples">Send</button>
                                                        <div id="dt-0" class="hidden">Charts For PHP Pages https://demo.appsbd.com/support-system/knowledge/details/15.html </div>
                                                    </li>
                                                    <li class="list-group-item apc-kn-li">
                                                        <a class="apc-kn-title popupform apopf" data-effect="mfp-move-from-top " target="_blank" href="https://demo.appsbd.com/support-system/knowledge/details/18.html">
                                                            Android Developer For Hiring</a>
                                                        <small>Android Basic</small>
                                                        <button data-id="#dt-0" class="kn-send-btn btn btn-xs btn-success added-ripples">Send</button>
                                                        <div id="dt-0" class="hidden">Android Developer For Hiring https://demo.appsbd.com/support-system/knowledge/details/18.html </div>
                                                    </li>
                                                </ul>
                                                <div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 193.498px;"></div>
                                                <div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <iframe id="app-print-iframe" style="border:none;height:0;width:0" __idm_frm__="594"></iframe>
</body>
