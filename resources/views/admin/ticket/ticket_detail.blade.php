...
<div id="main-content" class="content-wrapper" style="min-height: 213px;"><div id="MainFormLoader" class="MainLoader"><div class="msgText"></div></div>
...
<div class="panel-heading"><h4 class="m-0">{{$datas->ticket_subject}}</h4></div>
<div class="panel-body text-justify">
<p>{{$datas->ticket_body}}</p> </div>
</div>
...
<div class="pro-value">
<span class="text-info text-bold"><i class="fa fa-hourglass-1"></i> In Progress</span> </div>
</div>
</div>
...
<i data-tooltip-position="top" class="tooltip2 fa fa-eye-slash u-unseen tooltipstered added-tooltip2"></i> </div>
</div>
</div>
</div>
</div>
...
<div id="id_6_2" class=" panel panel-default app-panel-box m-b-10 ticket-reply admin-user">
<div class="panel-body text-justify">
<div class="user-type">Super Admin</div>
<div class="row">
<div class=" col-xs-3 col-sm-2 col-md-2 user-profile ">
...
<div class="pro-title">Ticket Status </div>
<div class="pro-value">
<span class="text-danger text-bold"><i class="fa fa-user"></i> Action Required</span> </div>
</div>
</div>
<div class="col-xs-6 col-sm-6">
</div>
<div class="col-xs-12 col-sm-2 text-right text-italic p-l-0">
 <a href="https://demo.appsbd.com/support-system/admin/ticket/edit-reply/6/2.html" class="popupformWR apopf" data-onclose="ReloadSiteUrl" data-effect="mfp-move-from-top">Edit</a> &nbsp;
<i data-tooltip-position="top" class="tooltip2 fa fa-eye-slash u-unseen tooltipstered added-tooltip2"></i> </div>
</div>
</div>
</div>
...
<input type="hidden" name="app_form" value="aa197bffc916399b696cd1641a7e24ba">
...
<div class="col-md-6"><a href = "#"><button type="submit" class="btn btn-success btn-block btn-sm added-ripples"> Reply</button></a></div>
</div>
</div>
</div>
</form>
...
<div class="panel-heading"><h4 class="m-0">Ticket Information</h4></div>
...
<td>{{$datas->id_ticket}}</td>
</tr>
<tr>
<th>Ticket User</th>
<th>:</th>
<td>
<div class="u-img-wrapr " style="margin-top: -5px;margin-bottom: -10px;"><div class="grid-img  offline "><div><img src="https://demo.appsbd.com/support-system/images/default-user-image.png" alt="[GUEST USER] " class=""></div></div><span class="grid-u-c">[GUEST USER] </span></div> <a data-effect="mfp-move-from-top" class="popupformWR btn btn-xs btn-info pull-right apopf added-ripples" href=" https://demo.appsbd.com/support-system/admin/client/profile/3.html">
...
<th>:</th>
<td><span>{{$datas->priority}}</span></td>
</tr>
<tr>
<th>Ticket Category</th>
<th>:</th>
<td class="abs-c h-c">{{$datas->ticket_category}}<div class="abs-r-t m-t-5 m-r-5 ">
</div>
</td>
</tr>
<tr>
...
<th>:</th>
<td id="assign-container" class="abs-c"><div class="u-img-wrapr " style="margin-top: -5px;margin-bottom: -10px;"><div class="grid-img  online "><div><img src="https://demo.appsbd.com/support-system/data/appuser/AA/profile.jpg" alt="admin (You) " class=""></div></div><span class="grid-u-c">admin (You) </span></div> <div class="abs-r-t m-t-5 m-r-5">
</div>
<button class="btn btn-success btn-theme btn-lg popupformWR apopf added-ripples" data-toggle="modal"
                                    data-target="#detailModal" data-effect="mfp-move-from-top"><span><i class="fa fa-lock"></i></span> Change</button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Assigned On Ticket
                                                </h4>
...
<div class="panel panel-light app-panel-box">
<div class="panel-heading bg-green"><h4 class="m-0"><i class="fa fa-sticky-note"></i> Admin Notes </h4>
</div>

<button class="btn btn-success btn-theme btn-lg popupformWR apopf added-ripples" data-toggle="modal"
                                    data-target="#NoteModal" data-effect="mfp-move-from-top"><span><i class="fa fa-lock"></i></span> Add Note</button>
                                ...
                                <form action="#" method="POST">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <p>Note On :</p>
                                                    <input type="radio" id="note_on" name="note_on" value="This Ticket">
                                                    <label for="note_on">This Ticket</label><br>
                                                    <input type="radio" id="note_on" name="note_on" value="Client">
                                                    <label for="note_on">Client</label><br>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
...
<div class="app-admin-note u-note">
<div class="apd-icon"><i class="fa  fa-user"></i></div> test<br>-<span class="note-user">admin (<span class="note-user-title">Super Admin</span>)</span> </div>
<div class="app-admin-note t-note">
<div class="apd-icon"><i class="fa  fa-ticket"></i></div> srgsr<br>-<span class="note-user">admin (<span class="note-user-title">Super Admin</span>)</span> </div>
<div class="app-admin-note t-note">
<div class="apd-icon"><i class="fa  fa-ticket"></i></div> 6utut<br>-<span class="note-user">admin (<span class="note-user-title">Super Admin</span>)</span> </div>
</div>
</div>
<div class="panel panel-success app-panel-box">
<div class="panel-heading bg-green"><h4 class="m-0"><i class="fa fa-clock-o"></i> Admin Work Log </h4></div>


<button class="btn btn-success btn-theme btn-lg popupformWR apopf added-ripples" data-toggle="modal"
                                    data-target="#logModal" data-effect="mfp-move-from-top"><span><i class="fa fa-lock"></i></span> Add Note</button>
...
<th width="10px">#</th>
<th width="60%">Note</th>
<th width="30%" class="text-right">Time</th>
</tr>
</thead>
<tbody>
<tr>
<td>1</td>
<td>
test<br>-<span class="note-user">admin (<span class="note-user-title">Super Admin</span>), <span class="w-note-time">Jul 28, 2020 23:07</span></span>
</td>
...
<td>2</td>
<td>
gseg<br>-<span class="note-user">admin (<span class="note-user-title">Super Admin</span>), <span class="w-note-time">Jul 28, 2020 23:23</span></span>
</td>
<td class="text-right">90 MIN</td>
</tr>
</tbody>
...
<th class="text-right">180 MIN</th>
</tr>
</tfoot>
</table>
</div>
