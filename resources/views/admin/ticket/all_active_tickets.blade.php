    ...
    <section class="content">
            ...
            <div class="box-body grid-body">
                ...
                <script type="text/javascript">
                    ...
                    function Grid_tab1_1595129082_download() {
                        ...
                        var durl = "https://demo.appsbd.com/support-system/admin/ticket-data/ticket-list/P.html?" + serialize(data);
                    ...
                    var config_tab1_1595129082 = {
                        ...
                        "width": "auto",
                        "height": "auto",
                        "url": "https:\/\/demo.appsbd.com\/support-system\/admin\/ticket-data\/ticket-list\/P.html",
                        "datatype": "json",
        ...
        <script type="text/javascript">
            ...
            function Reload_setting() {
                ...
                if (isChecked) {
                    //gcl("checked");
                    setCookie(appGlobalLang.base_cookie_name + "_48c5ad8f", "Y", 15, "/");
                    if (!reload_interval) {
                        //gcl("starting");
                    ...
                    try {
                        //gcl("unchecked");
                        deleteCookie(appGlobalLang.base_cookie_name + "_48c5ad8f");
